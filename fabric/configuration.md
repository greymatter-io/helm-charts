...
| jwt.jwt.image                         |             | docker.greymatter.io/release/gm-jwt-security:{{ .Values.jwt.version }} |
| jwt.jwt.port                          |             | 3000                                                                   |
...
| control.control.image                                                |             | docker.greymatter.io/release/gm-control:{{ $.Values.control.version }}                                 |
...
| control-api.controlApi.image                                         |             | docker.greymatter.io/release/gm-control-api:{{ $.Values.controlApi.version }}                          |
