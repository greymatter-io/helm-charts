...
| slo.slo.image                                   |             | docker.greymatter.io/release/gm-slo:{{ $.Values.slo.version }}                                                     |
...
| dashboard.dashboard.image                              |             | docker.greymatter.io/release/gm-dashboard:{{ $.Values.dashboard.version }}                |
